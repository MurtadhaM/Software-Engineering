...
from bcrypt import * 
import checkpw from flask_bcrypt
...
def login():
    ...
    if login_form.validate_on_submit():
        ...
        saltp = gensalt(14)
        hashp = hashpw(request.form['password'], gensalt(14)) 
        
        # if bcrypt.checkpw(request.form['password'].encode('utf-8'), the_user.password):
        if checkpw(request.form['password'].encode('utf-8'), the_user.password.encode('utf-8')):
